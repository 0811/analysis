!function (a, b) {
    ...
    var c = function (a, b) {
        var c = {
            ...
            image: "<li><div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'><div class='modal-header'><a class='close' data-dismiss='modal'>&times;</a><h3>" + b.image.insert + "</h3>" + "</div>" + "<div class='modal-body'>" + "<input value='http://' class='bootstrap-wysihtml5-insert-image-url input-xlarge'>" + "</div>" + "<div class='modal-footer'>" + "<a href='#' class='btn' data-dismiss='modal'>" + b.image.cancel + "</a>" + "<a href='#' class='btn btn-primary' data-dismiss='modal'>" + b.image.insert + "</a>" + "</div>" + "</div>" + "<a class='btn' data-wysihtml5-command='insertImage' title='" + b.image.insert + "'><i class='icon-picture'></i></a>" + "</li>",
    ...
    d.prototype = {
        constructor: d, createEditor: function (a) {
