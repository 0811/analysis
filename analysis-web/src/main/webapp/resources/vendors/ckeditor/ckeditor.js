...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var b = {
            ...
            basePath: function () {
                ...
                if (!a)for (var b = document.getElementsByTagName("script"), h = 0; h < b.length; h++) {
            ...
            domReady: function () {
                ...
                return function (b) {
                    ...
                    if (1 == h.length)if (document.addEventListener)document.addEventListener("DOMContentLoaded", a, !1), window.addEventListener("load", a, !1); else if (document.attachEvent) {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        a.prototype = {
            getListenerIndex: function (a) {
                for (var b = 0, h = this.listeners; b < h.length; b++)if (h[b].fn == a)return b;
                return -1
            }
        };
        return {
            define: function (a, d) {
                ...
                if (n.getListenerIndex(d) < 0) {
                    ...
                    i.fn = d;
                    i.priority = j;
                    for (var q = n.length - 1; q >= 0; q--)if (n[q].priority <= j) {
                        n.splice(q + 1, 0, i);
            ...
            once: function () {
                ...
                return function (j, i, l) {
                    var n = c(this)[j], j = a, o = h;
                    a = h = 0;
                    if (n) {
                        var q = n.listeners;
                        if (q.length)for (var q = q.slice(0), k, g = 0; g < q.length; g++) {
                            if (n.errorProof)try {
                                k = q[g].call(this,
                                    l, i, b, f)
                            } catch (p) {
                            } else k = q[g].call(this, l, i, b, f);
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        ...
        if (a.gecko)if (e < 10900)a.cssClass = a.cssClass + " cke_browser_gecko18"; else if (e <= 11E3)a.cssClass = a.cssClass + " cke_browser_gecko19";
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            arrayCompare: function (a, e) {
                ...
                var b = arguments.length, d, c;
                if (typeof(d = arguments[b - 1]) == "boolean")b--; else if (typeof(d = arguments[b - 2]) == "boolean") {
                    c = arguments[b - 1];
                    b = b - 2
                }
                for (var f = 1; f < b; f++) {
                    var j = arguments[f], i;
                    for (i in j)if (d === true || a[i] == void 0)if (!c ||
                        i in c)a[i] = j[i]
                }
                return a
                ...
                var b = a.$,
                    d = a.base, c = a.privates || a._, f = a.proto, a = a.statics;
                !b && (b = function () {
                ...
                return function () {
                    ...
                    window.setTimeout(function () {
                        a.apply(d, b)
                                           ...
                                           b) {
                var d = [], c, f = CKEDITOR.tools.parseCssText(a, true, b);
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend, c = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, h = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, f = {}, j = {"#": 1}, i = {
            center: 1,
            dir: 1,
            noframes: 1
        };
    ...
    (function (b) {
        ...
        b.removeCustomData = function (a) {
            var b = this.$["data-cke-expando"], b = b && c[b], d, h;
            if (b) {
                d = b[a];
                h = a in b;
                delete b[a]
        ...
        appendTo: function (b, c) {
            ...
            var a = this.$.cloneNode(b), e = function (a) {
                ...
                if (a.nodeType == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (b)for (var a = a.childNodes, h = 0; h < a.length; h++)e(a[h])
                }
            };
            e(a);
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (b) {
            ...
            for (var a = this.$.documentElement, e =
                0; a && e < b.length; e++) {
                var d = b[e];
                if (c)for (var h = -1, f = 0; f < a.childNodes.length; f++) {
    ...
    CKEDITOR.dom.element.setMarker = function (b, c, a, e) {
        var d = c.getCustomData("list_marker_id") || c.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"), h = c.getCustomData("list_marker_names") || c.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        b[d] = c;
        h[a] = 1;
    ...
    CKEDITOR.dom.element.clearMarkers = function (b, c, a) {
        var e = c.getCustomData("list_marker_names"), d = c.getCustomData("list_marker_id"), h;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    var c = ["top", "left", "right", "bottom"], h;
                    a == "border" && (h = ["color", "style", "width"]);
                    for (var b = [], f = 0; f < c.length; f++)if (h)for (var j = 0; j < h.length; j++)b.push([a, c[f], h[j]].join("-")); else b.push([a, c[f]].join("-"));
                ...
                var b = 0, c = 0, h = this.getDocument(), f = h.getBody(), j = h.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var i =
                        this.$.getBoundingClientRect(), l = h.$.documentElement, n = l.clientTop || f.$.clientTop || 0, o = l.clientLeft || f.$.clientLeft || 0, q = true;
                    if (CKEDITOR.env.ie) {
                ...
                j = a.getWindow();
                f = n(this, j);
                var k = n(a, j), g = this.$.offsetHeight;
                h = this.$.offsetWidth;
            ...
            copyAttributes: function (a, b) {
                for (var c = this.$.attributes, b = b || {}, h = 0; h < c.length; h++) {
                    var f = c[h], j = f.nodeName.toLowerCase(), i;
                    if (!(j in b))if (j == "checked" && (i = this.getAttribute(j)))a.setAttribute(j, i); else if (f.specified || CKEDITOR.env.ie && f.nodeValue && j == "value") {
    ...
    (function () {
        function b(a, b) {
            ...
            d = c.endContainer;
            var o = c.startOffset, e = c.endOffset, k, g = this.guard, p = this.type, h = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var u = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), m = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(e) : d.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !u.equals(a)) && (!m || !a.equals(m)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var E = n.type == CKEDITOR.NODE_ELEMENT ? n : n.getParent(), A = n.type == CKEDITOR.NODE_ELEMENT ? o ? n.getChild(o - 1) : null : n.getPrevious();
            ...
            if (this.current)d = this.current[h](false, p, k); else {
                if (a)d.type ==
                CKEDITOR.NODE_ELEMENT && (d = e > 0 ? d.getChild(e - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, p, k)); else {
                    d = n;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, d = CKEDITOR.dom.walker.whitespaces(), h = CKEDITOR.dom.walker.bookmark();
    ...
    (function () {
        ...
        var e = function (a) {
            ...
            a.optimizeBookmark();
            var g = a.startContainer, d = a.endContainer, e = a.startOffset, h = a.endOffset, f, i;
            if (d.type == CKEDITOR.NODE_TEXT)d = d.split(h); else if (d.getChildCount() > 0)if (h >= d.getChildCount()) {
            ...
            var e = g.getParents(), h = d.getParents(), j, r, x;
            ...
            for (c = j; c < h.length; c++) {
                ...
                if (!e[c] || s.$.parentNode != e[c].$.parentNode)for (s = s.getPrevious(); s;) {
            ...
            u: 1,
            "var": 1
        }, f = CKEDITOR.dom.walker.bogus(), j = new CKEDITOR.dom.walker.whitespaces, i = new CKEDITOR.dom.walker.bookmark, l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b = this.startContainer, c = this.endContainer, d = this.startOffset, g = this.endOffset, p = this.collapsed, e, h;
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) {
                    g = b.getChildCount();
                    if (g > d)b = b.getChild(d).getPreviousSourceNode(true); else if (g < 1)b = b.getPreviousSourceNode();
                    else {
                ...
                var c = this.startContainer,
                    d = this.startOffset, g = this.collapsed;
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var d = this.getCommonAncestor(), g = this.root, e, h, f, m, i, j = false, r, x;
                            ...
                            for (; m;) {
                                ...
                                if (m.type == CKEDITOR.NODE_COMMENT)m = m.getPrevious(); else {
                                    if (m.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        /[^\s\ufeff]/.test(x) && (m = null);
                                        r = /[\s\ufeff]$/.test(x)
                                    } else if ((m.$.offsetWidth > 0 || b && m.is("br")) && !m.data("cke-bookmark"))if (j && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                        x =
                                            m.getText();
                                        if (/[^\s\ufeff]/.test(x))m = null; else for (var l = m.$.getElementsByTagName("*"), s = 0, C; C = l[s++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                            m = null;
                                            break
                                        }
                                        m && (r = !!x.length)
                        ...
                        for (; f || m;) {
                            ...
                            for (; m;) {
                                ...
                                if (m.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    if ((m.$.offsetWidth > 0 || b && m.is("br")) && !m.data("cke-bookmark"))if (j && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                        x =
                                            m.getText();
                                        if (/[^\s\ufeff]/.test(x))m = null; else {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var y, t, w = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), I = function (a) {
                            var b = w(a);
                            b || (y = a);
                            return b
                        }, c = function (a) {
                ...
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), g = this.startContainer, f = this.endContainer, e = this.startOffset, h = this.endOffset, m = 1, i = 1;
                    ...
                    var d = new CKEDITOR.dom.walker(d), j = CKEDITOR.dom.walker.bookmark();
            ...
            moveToPosition: function (a, b) {
                ...
                var b =
                    new CKEDITOR.dom.elementPath(this.startContainer, this.root), c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), d = b.block, g = c.block, f = null;
    ...
    (function () {
        ...
        var a = /^[\r\n\t ]+$/, e = CKEDITOR.dom.walker.bookmark(false, true), d = CKEDITOR.dom.walker.whitespaces(true), h = function (a) {
            return e(a) && d(a)
        };
        b.prototype = {
            getNextParagraph: function (b) {
                ...
                for (this._.nextNode = null; k;) {
                    var g = 0, p = k.hasAscendant("pre"), v = k.type != CKEDITOR.NODE_ELEMENT, u = 0;
                    if (v)k.type == CKEDITOR.NODE_TEXT && a.test(k.getText()) && (v = 0); else {
                        var m = k.getName();
                        if (k.isBlockBoundary(this.forceBrBreak && !p && {br: 1})) {
                            if (m == "br")v = 1; else if (!i && !k.getChildCount() && m != "hr") {
                                d = k;
                                l = k.equals(n);
                                break
                            }
                    ...
                    l = (!g || v) && k.equals(n);
                    if (i && !g)for (; !k.getNext(h) && !l;) {
                        m = k.getParent();
                        if (m.isBlockBoundary(this.forceBrBreak && !p && {br: 1})) {
                            g = 1;
                            v = 0;
                            l || m.equals(n);
    ...
    (function () {
                ...
                if (f = !e) {
                    a:if (a.nothingRequired)f = true; else {
                        if (e = a.requiredClasses) {
                            h = b.classes;
                            for (f = 0; f < e.length; ++f)if (CKEDITOR.tools.indexOf(h, e[f]) == -1) {
                                f = false;
                                break a
                            }
                        }
        ...
        function e(a) {
            ...
            return a._.filterFunction = function (g, f, e, h, k, m, t) {
                ...
                if (f) {
                    var o = g.name, e = f.elements[o], j = f.generic, f = {
                    ...
                    e = f.validClasses;
                    v = g.attributes;
                    var j = g.styles, r = v["class"], w = v.style, q, x, A = [], s = [], E = /^data-cke-/, z = false;
                    delete v.style;
                    delete v["class"];
                    if (!f.allAttributes)for (q in v)if (!m[q])if (E.test(q)) {
                    ...
                    if (f.allClasses)r && (v["class"] = r); else {
        ...
        function g(a, b, c) {
            var g = a.name;
            if (A.$empty[g] || !a.children.length)if (g == "hr" && b == "br")a.replaceWith(q()); else {
        ...
        function v(a, b) {
            var c = b.getDefinition(), g = c.attributes, d = c.styles, f, e, h, p;
            ...
            for (e in d)if (a.styles[e] != d[e])return false;
            return true
        }
        ...
        var A = CKEDITOR.dtd, r = CKEDITOR.tools.copy, x = CKEDITOR.tools.trim, z = "cke-test";
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b,
                ...
                this._.cachedChecks = {};
                var d, e;
                if (typeof b == "string")b = f(b); else if (b instanceof CKEDITOR.style) {
                    e = b.getDefinition();
                    g = {};
                    b = e.attributes;
                    g[e.element] = e = {
                ...
                for (h in b) {
                    ...
                    for (m in s) {
                        p[m] = a(p[m], k) || null;
                        var t = p, i = C[m], v = a(p[C[m]], k), j = p[m], u = [], q = true, w = void 0;
                        v ? q = false : v = {};
                ...
                for (p = g.length; e < p; ++e) {
                    ...
                    if (k.elements === true || k.elements === null) {
                        ...
                        t =
                            k.elements;
                        delete k.elements;
                        for (d in t)if (h[d])h[d][m ? "unshift" : "push"](k); else h[d] = [k]
                    }
                }
                c.elements = h;
                ...
                var d = [], f = !c && this._.rules, h = this._.transformations, p = e(this), k = this.editor && this.editor.config.protectedSource, m = false;
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a:{
                            ...
                            c = [];
                            var e, o, t;
                            if (k)for (o = 0; o < k.length; ++o)if ((t = g.match(k[o])) && t[0].length == g.length) {
                                c = true;
                                break a
                            }
                ...
                if (typeof a == "string") {
                    ...
                    d = {
                        name: g.element, attributes: o, classes: o["class"] ?
                            o["class"].split(/\s+/) : [], styles: d, children: []
                    }
                }
                var o = CKEDITOR.tools.clone(d), m = [], t;
        ...
        var s = {styles: 1, attributes: 1, classes: 1}, C = {
        ...
        }, y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, t = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
            ...
            sizeToStyle: function (a) {
                ...
                if (typeof b == "string")a.name = b; else {
                    var c = b.getDefinition(), g = c.styles, d = c.attributes, e, f, h, p;
                    a.name = c.element;
    ...
    (function () {
        var b, c = function (a) {
            var a = a.data, c = a.getKeystroke(), h = this.keystrokes[c], f = this._.editor;
            b = f.fire("key", {keyCode: c}) === false;
            if (!b) {
                h && (b = f.execCommand(h, {from: "keystrokeHandler"}) !== false);
    ...
    (function () {
        CKEDITOR.lang = {
            languages: {
                ...
                var a = this.languages, c = c || navigator.userLanguage || navigator.language || b, e = c.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/), d = e[1], e = e[2];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (a, e, d, h) {
                ...
                f && (a = [a]);
                d || (d = CKEDITOR);
                var j = a.length, i = [], l = [], n = function (a) {
                    ...
                    var o = function (a, b) {
                        ...
                        if (b[a])o(a, true); else {
                            ...
                            if (!(g.length >
                                ...
                                if (e)if (CKEDITOR.env.ie)d.$.onreadystatechange = function () {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (b, c) {
            ...
            CKEDITOR.scriptLoader.load(h, function (b,
                ...
                for (var h = 0; h < b.length; h++)for (var g = f[b[h]], p = 0; p < g.length; p++) {
                    var i = g[p];
                    j[i] = this.get(i);
                    e[i] = 1
                }
        ...
        return function (a, e, d) {
            var h = {}, f = function (a) {
                b.call(this, a, function (a) {
                    ...
                    var b = [], j;
                    for (j in a) {
                        var o = a[j], q = o && o.requires;
                        if (!c[j]) {
                            if (o.icons)for (var k = o.icons.split(","), g = k.length; g--;)CKEDITOR.skin.addIcon(k[g], o.path + "icons/" + (CKEDITOR.env.hidpi && o.hidpi ? "hidpi/" : "") + k[g] + ".png");
                            c[j] = 1
                        }
                        if (q) {
                            q.split && (q = q.split(","));
    ...
    (function () {
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var k in c) {
                    var o = c[k], m = o.lang, i = null, j = o.requires,
                        v;
                    ...
                    if (m && !a.lang[k]) {
                        m.split && (m = m.split(","));
                        if (CKEDITOR.tools.indexOf(m, a.langCode) >= 0)i = a.langCode; else {
                            i = a.langCode.replace(/-.*/, "");
                            i = i != a.langCode && CKEDITOR.tools.indexOf(m, i) >= 0 ? i : CKEDITOR.tools.indexOf(m, "en") >= 0 ? "en" : m[0]
                        }
                        if (!o.langEntries || !o.langEntries[i])f.push(CKEDITOR.getUrl(o.path + "lang/" + i + ".js")); else {
        ...
        CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () {
                ...
                for (var e, d, h = 0, f; e = this._.htmlPartsRegex.exec(a);) {
                    ...
                    if (d > h) {
                        h = a.substring(h, d);
                        if (f)f.push(h); else this.onText(h)
                    }
                    h =
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            remove: function () {
                ...
                var c = this.parent.children, a = CKEDITOR.tools.indexOf(c, this), e = b.previous = this.previous, d = b.next = this.next;
                e && (e.next = b);
                d && (d.previous = b);
                c[a] = b;
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, h, f) {
            function j(a) {
                ...
                if (p.length > 0)for (var c = 0; c < p.length; c++) {
                    var d = p[c], g = d.name, f = CKEDITOR.dtd[g], e = u.name &&
                        CKEDITOR.dtd[u.name];
            ...
            var k = new CKEDITOR.htmlParser, g = h instanceof CKEDITOR.htmlParser.element ? h : typeof h == "string" ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, p = [], v = [], u = g, m = g.name == "textarea", E = g.name == "pre";
            k.onTagOpen = function (d, g, f, h) {
                g = new CKEDITOR.htmlParser.element(d, g);
                if (g.isUnknown && f)g.isEmpty = true;
                g.isOptionalClose = h;
                if (b(g))p.push(g); else {
                    ...
                    if (d == "br")v.push(g); else {
                        for (; ;) {
                            h = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : e;
                            if (!g.isUnknown && !u.isUnknown && !h[d])if (u.isOptionalClose)k.onTagClose(f); else if (d in a && f in a) {
                                f = u.children;
                                (f = f[f.length - 1]) && f.name == "li" || n(f = new CKEDITOR.htmlParser.element("li"), u);
                                !g.returnPoint && (g.returnPoint = u);
                                u = f
                            } else if (d in CKEDITOR.dtd.$listItem && !q(d, f))k.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (f in c && !q(d, f)) {
                                !g.returnPoint &&
                                (g.returnPoint = u);
                                u = u.parent
                            } else {
                                f in CKEDITOR.dtd.$inline && p.unshift(u);
                                if (u.parent)n(u, u.parent, 1); else {
                                    g.isOrphan = 1;
                                    break
                                }
                            } else break
            ...
            k.onText = function (b) {
                ...
                var d = u.name, g = d ? CKEDITOR.dtd[d] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : e;
                if (!m && !g["#"] && d in c) {
    ...
    (function () {
        function b(b, c) {
            ...
            function k(b, c) {
                return function (d) {
                    if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var f = [], k = a(d), p, t;
                        if (k)for (o(k, 1) && f.push(k); k;) {
                            if (h(k) && (p = e(k)) && o(p))if ((t = e(p)) && !h(t))f.push(p); else {
                                var q = p, j = g(m), w = q.parent.children, B = CKEDITOR.tools.indexOf(w, q);
                                w.splice(B + 1, 0, j);
                                w = q.next;
                                q.next = j;
                                j.previous = q;
                        ...
                        if (f = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(d) !== false : c))if (!m && CKEDITOR.env.ie && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)f = false; else if (!m && CKEDITOR.env.ie && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem))f = false; else {
                            f = a(d);
            ...
            function o(a, b) {
                ...
                if (a.type ==
                    ...
                    if (!m)if ((c = a.previous) && c.name == "br" || !c || h(c))return true
                }
                return false
            }

            var p = {elements: {}}, m = c == "html", t = CKEDITOR.tools.extend({}, z), q;
        ...
        CKEDITOR.htmlDataProcessor = function (a) {
            ...
            a.on("toHtml", function (b) {
                var b = b.data, d = b.dataValue, d = m(d, a), d = k(d, G), d = q(d), d = k(d, I), d = d.replace(Q, "$1cke:$2"), d = d.replace(F, "<cke:$1$2></cke:$1>"), d = CKEDITOR.env.opera ? d : d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), e = b.context || a.editable().getName(), f;
        ...
        var E = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", r = CKEDITOR.dtd, x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], z = CKEDITOR.tools.extend({}, r.$blockLimit, r.$block), s = {
            elements: {},
        ...
        var t = /<(a|area|img|input|source)\b([^>]*)>/gi, w = /\s(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, I = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, G = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, D = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, Q = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, L = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, F = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: c.add, clone: function () {
                ...
                for (f in c) {
                    j = f;
                    for (h = c[f]; ;)if (j = a.onAttributeName(f))if (j != f) {
                        delete c[f];
                        f = j
                    } else break; else {
                        delete c[f];
    ...
    (function () {
        CKEDITOR.inline = function (b, c) {
            ...
            var a = new CKEDITOR.editor(c, b, CKEDITOR.ELEMENT_MODE_INLINE), e = b.is("textarea") ? b : null;
            if (e) {
        ...
        CKEDITOR.inlineAll = function () {
            var b, c, a;
            for (a in CKEDITOR.dtd.$editable)for (var e = CKEDITOR.document.getElementsByTag(a), d = 0, h = e.count(); d < h; d++) {
                b = e.getItem(d);
    ...
    (function () {
        function b(b) {
            ...
            if (CKEDITOR.env.gecko) {
                var m = g.block || g.blockLimit || g.root, i = m && m.getLast(a);
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            $: function (a, b) {
                ...
                focus: function () {
                    ...
                    if (!b) {
                        var e = /\n{2}/g;
                        if (e.test(a))var f = "<" + c + ">", i = "</" + c + ">", a = f + a.replace(e, function () {
                                return i + f
                            }) + i
                    }
                    a = a.replace(/\n/g, "<br>");
                    ...
                    for (var c = this.editor, d = c.config.enterMode,
                        ...
                        if (!m.checkReadOnly()) {
                            ...
                            n = !r && b || b.clone(1);
                            var x, z;
                            if (j)for (; (x = m.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[x.getName()]) && (!z || !z[i]);)if (x.getName()in CKEDITOR.dtd.span)m.splitElement(x); else if (m.checkStartOfBlock() && m.checkEndOfBlock()) {
                                m.setStartBefore(x);
                                m.collapse(true);
                                x.remove()
                    ...
                    if (l) {
                        ...
                        if (j)if ((b = l.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))b.getDtd()["#"] ? m.moveToElementEditStart(b) : m.moveToElementEditEnd(l); else if (!b && d != CKEDITOR.ENTER_BR) {
                ...
                getData: function (a) {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in{8: 1, 46: 1}) {
                                var e = a.getSelection(), b = e.getRanges()[0], f = b.startPath(), k, h, j, c = c == 8;
                                if (e = d(e)) {
                                    a.fire("saveSnapshot");
                                    ...
                                    a.fire("saveSnapshot");
                                    g = 1
                                } else if (b.collapsed)if ((k = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (j = k[c ? "getPrevious" : "getNext"](i)) && j.is("table")) {
                                    a.fire("saveSnapshot");
        ...
        var n = function () {
            ...
            function d(a, c) {
                var g = [], e = a.getChildren(), f = e.count(), h, m = 0, p = i[c], j = !a.is(i.$inline) || a.is("br");
                for (j && g.push(" "); m < f; m++) {
                    h = e.getItem(m);
            ...
            var i = CKEDITOR.dtd, m = {
                ...
                dl: 1,
                blockquote: 1
            }, j = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, n = CKEDITOR.tools.extend({}, i.$inline);
            delete n.br;
            return function (m, l, z) {
                ...
                if (!C.checkReadOnly()) {
                    var t = (new CKEDITOR.dom.elementPath(C.startContainer,
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, s = l.range, y = l.mergeCandidates, w, I, G, D;
                    ...
                    if (!s.collapsed) {
                        var t = G.block || G.blockLimit, Q = s.getCommonAncestor();
                    ...
                    for (t = w.startNode; (t = t.getParent()) && g(t);)y.push(t);
                    s.moveToBookmark(w);
                    if (w = z) {
                        w = l.range;
                    ...
                    if (w) {
                        F = l.range;
                        var L = F.document, B, z = l.blockLimit;
                        w = 0;
                        var J;
                        D = [];
                        var H, N, y = s = 0, K, O;
                        I = F.startContainer;
                        var t = l.endPath.elements[0], P;
                        G = t.getPosition(I);
    ...
    (function () {
        ...
        function e(a) {
            ...
            var c = a.startContainer, d = a.getPreviousNode(n, null, c), e = a.getNextNode(n, null, c);
        ...
        function h(a, b) {
            ...
            if (c) {
                if (b !== false) {
                    var d, e = a.getDocument().getSelection().getNative(), h = e && e.type != "None" &&
                        e.getRangeAt(0);
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            e.on("contentDom", function () {
                var a = e.document, d = CKEDITOR.document, g = e.editable(), f = a.getBody(), k = a.getDocumentElement(), i = g.isInline(), j;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                var a = o ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var f = d.children, h, i, k = b.duplicate(), j = 0, l = f.length - 1, n = -1, t, o; j <= l;) {
                            ...
                            if (t > 0)l = n - 1; else if (t < 0)j = n + 1; else {
                    ...
                    if (b)for (var d = c.ranges, e = 0; e < d.length; e++) {
                        ...
                        if (!f.collapsed) {
                            ...
                            b =
                                f.startContainer;
                            h = f.endContainer;
                            var i = f.startOffset, j = f.endOffset, l = f.clone();
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    if (o) {
                        var c = CKEDITOR.dom.walker.whitespaces(true), d = /\ufeff|\u00a0/, f = {
                            table: 1,
                            tbody: 1,
                            tr: 1
                        };
                        ...
                        var b = a[0], a = b.collapsed, i, j, l, n = b.getEnclosedNode();
        ...
        if (!a) {
            ...
            this.on("selectionChange", function (b) {
                for (var c = 0; c < a.length; c++) {
                    var h = a[c], f = h.style.checkActive(b.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    h.fn.call(this, f)
                }
            })
        }
    ...
    (function () {
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                a.trim();
                var j = a.createBookmark(), l = j.startNode, k = j.endNode, n = l, o;
                if (!g) {
                    var m = a.getCommonAncestor(), g = b(l, m), m = b(k, m);
                ...
                for (n.getPosition(k) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(k)) {
                        ...
                        var r = n.type, s = r == CKEDITOR.NODE_ELEMENT ? n.getName() : null, m = s && n.getAttribute("contentEditable") == "false", u = s && n.getAttribute("data-nostyle");
                        ...
                        if (!s || i[s] && !u && (!m || h) && (n.getPosition(k) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(n))) {
                            ...
                            if (v && ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(v))) {
                                ...
                                if (r == CKEDITOR.NODE_TEXT || m || r == CKEDITOR.NODE_ELEMENT && !n.getChildCount()) {
                                    for (var r = n, x; (g = !r.getNext(C)) && (x = r.getParent(), i[x.getName()]) && (x.getPosition(l) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule ||
                                    e.childRule(x));)r = x;
                                    o.setEndAfter(r)
                                }
                            } else g = true
                    ...
                    if (g && o && !o.collapsed) {
                        for (var g = p(this, c), m = g.hasAttributes(), u = o.getCommonAncestor(), r = {}, s = {}, v = {}, z = {}, y, A, E; g && u;) {
                            if (u.getName() == d) {
                                for (y in e.attributes)if (!z[y] && (E = u.getAttribute(A)))g.getAttribute(y) == E ? s[y] = 1 : z[y] = 1;
                                for (A in e.styles)if (!v[A] && (E = u.getStyle(A)))g.getStyle(A) == E ? r[A] = 1 : v[A] = 1
                            }
                            u = u.getParent()
                        }
        ...
        function o(a) {
            var b = this._.definition, c = b.attributes, b = b.styles, d = m(this)[a.getName()], e = CKEDITOR.tools.isEmpty(c) && CKEDITOR.tools.isEmpty(b), f;
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (c, d) {
            var h = null, f = null, j = [], d = d || c.getDocument().getBody(), i = c;
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (b) {
            ...
            for (c = 0; c < h; c++)if (e(d[c]))return d[c];
            return null
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var c = this.$.parentNode, a = c.childNodes.length, e = this.getLength(), d = this.getDocument(), h = new CKEDITOR.dom.text(this.$.splitText(b), d);
    ...
    (function () {
        function b(a, b, c) {
            var h = a.serializable, f = b[c ? "endContainer" : "startContainer"], j = c ? "endOffset" : "startOffset", i = h ? b.document.getById(a.startNode) : a.startNode, a = h ? b.document.getById(a.endNode) : a.endNode;
        ...
        var c = {
            createIterator: function () {
                var a = this, b = CKEDITOR.dom.walker.bookmark(), c = [], h;
                return {
                    getNextRange: function (f) {
                        h = h == void 0 ? 0 : h + 1;
                        var j = a[h];
                        if (j && a.length > 1) {
                            if (!h)for (var i = a.length - 1; i >= 0; i--)c.unshift(a[i].createBookmark(true));
                            if (f)for (var l = 0; a[h + l + 1];) {
                                for (var n = j.document, f = 0, i = n.getById(c[l].endNode), n = n.getById(c[l +
                                1].startNode); ;) {
                                    i = i.getNextSourceNode(false);
                                    if (n.equals(i))f = 1; else if (b(i) || i.type == CKEDITOR.NODE_ELEMENT && i.isBlockBoundary())continue;
                                    break
                                }
                                if (!f)break;
                                l++
    ...
    (function () {
        ...
        var f = "cke_ui_color", j = [], i = /\$color/g;
        CKEDITOR.on("instanceLoaded", function (a) {
    ...
    CKEDITOR.plugins.add("wsc", {
        requires: "dialog", parseConfig: function (a) {
