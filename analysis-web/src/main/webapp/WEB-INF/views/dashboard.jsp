...
<html>
    <head>
        ...
        <!-- Vendors -->
        <link rel="stylesheet" media="screen" href="resources/vendors/easypiechart/jquery.easy-pie-chart.css">
        <link rel="stylesheet" media="screen" href="resources/vendors/easypiechart/jquery.easy-pie-chart_custom.css">
    ...
    <body class="bootstrap-admin-with-small-navbar">
        ...
        <script type="text/javascript" src="resources/js/twitter-bootstrap-hover-dropdown.min.js"></script>
        <script type="text/javascript" src="resources/js/bootstrap-admin-theme-change-size.js"></script>
        <script type="text/javascript" src="resources/vendors/easypiechart/jquery.easy-pie-chart.js"></script>
