package com.demep.analysis.common.store.file;
 ...
 * continue to use a {@code FileQueue} instance after an exception.
 * <p/>
...
public class FileQueue {
    ...
    /**
     * Constructs a new queue backed by the given file. Only one {@code FileQueue}
     ...
     * For testing.
     */
    FileQueue(RandomAccessFile raf) throws IOException {
        this.raf = raf;
        readHeader();
    }
